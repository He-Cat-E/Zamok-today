            ...
            <div className="mt-10 grid gap-6 md:grid-cols-3">
              {[
                ...
                >
                  ...
                  <h3
                    className={`mt-5 text-xl font-semibold leading-snug tracking-tight text-zinc-900 dark:text-white md:text-2xl`}
                  >
                    {tr(t, s.title, "")}
                  </h3>
          ...
          <div className="mx-auto max-w-[1440px] px-4">
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
              {[
                ...
                >
                  <h3 className={`text-xl font-semibold leading-snug tracking-tight text-zinc-900 dark:text-white md:text-2xl`}>
                    {tr(t, card.title, "")}
                  </h3>
          ...
          <div className="mx-auto max-w-[1440px] px-4">
            ...
            <ul className="mt-8 grid gap-3 sm:grid-cols-2">
              {COVER_ITEMS.map((key) => (
                ...
                >
                  <FiCheck className="h-5 w-5 shrink-0 text-brand-600 dark:text-zinc-300" />
