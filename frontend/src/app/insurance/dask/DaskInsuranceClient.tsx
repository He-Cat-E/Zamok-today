  ...
  return (
    <div className="flex justify-center" title={label}>
      ...
      {yes ? (
        ...
        <span className="grid h-9 w-9 place-items-center rounded-full bg-red-600 text-white shadow-sm dark:bg-red-700">
        ...
        <section className="relative overflow-hidden bg-red-600 dark:bg-black">
          <div className="relative mx-auto grid max-w-[1440px] gap-10 px-4 py-12 lg:grid-cols-2 lg:items-center lg:py-16">
            <div className="text-white">
              ...
              <h1 className={`${recoleta.className} text-3xl font-bold leading-tight tracking-tight md:text-4xl lg:text-5xl`}>{daskHeroTitle(t)}</h1>
            ...
            <ul className="mt-4 flex flex-col gap-2">
              {NEED_LIST_KEYS.map((key) => (
                <li key={key} className="flex gap-3 text-sm leading-relaxed text-zinc-700 dark:text-zinc-300 md:text-base">
                  <span className="mt-0.5 grid h-7 w-7 shrink-0 place-items-center rounded-lg bg-red-600 text-white">
