      ...
      <div className="grid gap-6 lg:grid-cols-[280px_1fr]">
        ...
        <div className="space-y-6">
          <section className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm ring-1 ring-zinc-900/5 dark:border-white/10 dark:bg-zinc-950 dark:ring-white/10">
            ...
            <form onSubmit={onSave} className="mt-5 max-w-lg space-y-4">
              <div>
                <label
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    autoComplete="name"
                    className="w-full rounded-xl border border-zinc-200 bg-white py-2.5 pl-10 pr-3 text-sm text-zinc-900 outline-none ring-brand-600/30 focus:border-brand-500 focus:ring-2 dark:border-white/15 dark:bg-black dark:text-white dark:focus:border-white/30"
                  />
                </div>
              </div>
              <div>
                ...
                <div className="flex items-center gap-2 rounded-xl border border-zinc-200 bg-zinc-50 px-3 py-2.5 text-sm text-zinc-600 dark:border-white/10 dark:bg-black dark:text-zinc-400">
              ...
              <button
                type="submit"
                disabled={saving || fullName.trim() === user.fullName.trim()}
